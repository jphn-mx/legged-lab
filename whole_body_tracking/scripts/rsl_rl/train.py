...
parser.add_argument("--motion_file", type=str, default=None, help="Local path to the motion npz file.")
parser.add_argument("--motion_name", type=str, default=None, help="Motion name (loads from scripts/motions/<name>.npz).")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    if args_cli.motion_name:
        motion_path = os.path.join(MOTIONS_DIR, f"{args_cli.motion_name}.npz")
        ...
        raise ValueError("Either --motion_name, --motion_file, or --registry_name must be provided.")
